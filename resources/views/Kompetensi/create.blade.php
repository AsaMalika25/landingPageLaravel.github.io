...
@csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="judul_kompetensi" value="{{ isset($data_kompetensi->judul) ? $data_kompetensi->judul : ''}}" class="form-control">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="deskripsi" class="col-sm-2 col-form-label">deskripsi</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control"value="{{ isset($data_kompetensi->deskripsi) ? $data_kompetensi->deskripsi : ''}}" name='deskripsi' id="deskripsi">
                </div>
            </div>
            {{-- <div class="mb-3 row">
