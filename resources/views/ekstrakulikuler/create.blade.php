...
@csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="judul_ekstrakulikuler" value="{{ isset($data_ekstrakulikuler->judul) ? $data_ekstrakulikuler->judul : ''}}" class="form-control">
                </div>
            </div>
            <div class="mb-3 row">
                <label for="deskripsi" class="col-sm-2 col-form-label">deskripsi</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control"value="{{ isset($data_ekstrakulikuler->deskripsi) ? $data_ekstrakulikuler->deskripsi : ''}}" name='deskripsi' id="deskripsi">
                </div>
            </div>
            {{-- <div class="mb-3 row">
